...
progress: "Codex round 2 rejected on cache isolation; this revision transfers a seeded cache through an immutable artifact into a fresh runner, adds deliberate non-default Vite+ fixtures, and executes the cache binary."
depends_on: []
