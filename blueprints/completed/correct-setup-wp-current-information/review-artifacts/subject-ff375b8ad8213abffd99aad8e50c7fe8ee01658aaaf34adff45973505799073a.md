...
- [_] README and inputs.package-root.description match executable exports exactly: WEBPRESSO_PACKAGE_ROOT, legacy WEBPRESSO_AGENT_KIT_ROOT, and NODE_PATH; they reject removed WP_AGENT_KIT_PACKAGE_ROOT and state missing catalog fails closed. No executable export/failure behavior changes.
...
| --- | --- | --- | __wp-gate-result__ | --- |
| GitHub Actions secret-reference audit | wp audit github-actions-secrets | GitHub Actions workflows and action metadata satisfy repository secret-reference policy while documenting tokenless setup-wp behavior. | __wp-gate-result__ | pre-implementation |
