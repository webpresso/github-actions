...
- [ ] The focused test reads README.md, setup-wp/action.yml, and webpresso-freshness.yml and demonstrably fails before prose correction for known source-parity contradictions.
